				...
				if (( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) )  ) {
					...
					<div class="post-content">
						...
						<div class="post-meta">
							...
							<span class="vcard author"><i class="mini-ico-user"></i>By  <a class="fn author-link" href="<?php echo get_author_posts_url(get_the_author_meta('ID' )); ?>"><?php the_author_meta('display_name'); ?></a></span>
							<?php if($comments != "yes") { ?>
