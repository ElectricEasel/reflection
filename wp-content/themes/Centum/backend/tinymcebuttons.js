            ...
            ed.addButton('columns',
                {
                    ...
                    text: 'Quick Shortcodes',
                    icon: false,
                    onselect: function(e) {
                        tinymce.execCommand('mceInsertContent', false, e.control['_value']);
                    },
                'values': [
                    {text: '1/3 + 2/3', value: '[column width="1/3" place="first" ] [/column] [column width="2/3" place="last" ] [/column] '},
                    {text: '1/3 + 1/3 + 1/3 ', value: '[column width="1/3" place="first" ] [/column] [column width="1/3" place="none" ] [/column] [column width="1/3" place="last" ] [/column] '},
                    {text: '1/2 + 1/2', value: '[column width="eight" place="first" ] [/column] [column width="eight" place="last" ] [/column] '},
                    {text: 'Headline h4', value: '[headline htype="h4"] [/headline]'},
                    {text: 'Headline low margin', value: '[headline margin="low-margin"] [/headline]'},
                    {text: 'Headline margin', value: '[headline margin="margin"] [/headline]'},
                ]
            });
...
/* ed.addButton('columns', {
                ...
                menu:[{text:'submenu1',value:'some value'},{text:'submenu2',value:'some value'}]},
...
setTimeout(function() {
        jQuery('.mce-widget.mce-btn').each(function() {
            var btn = jQuery(this);
            if (btn.attr('aria-label')=="Quick Shortcodes")
